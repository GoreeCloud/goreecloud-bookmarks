...
**Roadmap status:** Planned; no phase is complete unless exact authoritative evidence is cited.  
**Canonical product scope:** `SPECIFICATIONS.md` and the canonical GoreeCloud Bookmarks project specification.

This roadmap orders intended work. It is not release evidence, a delivery commitment, or proof that any capability exists.

## Milestone 0 — Governed repository foundation

- Complete the required root documentation baseline.
...
Concept → Experimental → Development → Release Candidate → Stable

Movement between lifecycle states requires authoritative evidence and is not implied by roadmap progress.
