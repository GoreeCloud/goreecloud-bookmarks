...
This directory is the Firefox client maintained inside the canonical GoreeCloud Bookmarks application repository.
...
The Firefox client follows the controlled first-party replacement path rather than copying obsolete Safari/Xcode material or unnecessarily broad Firefox privileges. Historical provenance is retained in this client migration record and repository history.
