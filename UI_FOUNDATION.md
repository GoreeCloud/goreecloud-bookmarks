...
Every code-bearing head of this branch must pass the GoreeCloud web build and inherited login regression suite before it is considered for merge into the identity branch. Broader responsive, visual, keyboard, and interaction testing is still required before any production release.
